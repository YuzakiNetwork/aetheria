...
async function sendGroupWelcomeMessages(sock, groupId, participants, metadata) {
	if (
		!sock ||
		!groupId ||
	...
	try {
		...
		print.error(`[Welcome] Failed sending welcome to ${groupId}:`, error);
	}
}
